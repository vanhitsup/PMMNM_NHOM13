                            ...
                            <div class="tab-pane active" id="shopping-cart">
                                <div class="shopping-cart-content">
                                        ...
                                        <div class="table-content table-responsive mb-50">
                                            <form action="{{\Illuminate\Support\Facades\URL::to('update-cart-ajax')}}" method="post">
                                                @csrf
...
{{--                                                    @if(Session::get('cart')==true)--}}
                                                    ...
                                                    @foreach(Session::get('cart') as $key => $cart)
                                                        ...
                                                        @endphp
                                                        <tr>
                                                            <td class="product-thumbnail" style="padding: 10px 20px" >
                                                                <div class="pro-thumbnail-img" style="width: 10%;">
                                                                    <img src="{{\Illuminate\Support\Facades\URL::to('../public/uploads/products/'.$cart['product_image'])}}"  alt="">
                                                                </div>
                                                            ...
                                                            <td style="padding: 10px 20px"  class="product-price"> {{number_format($cart['product_price'])}} đ</td>
                                                            <td style="padding: 10px 20px"  class="product-quantity">
                                                                <input type="number" min="1" value="{{$cart['product_qty']}}" name="cart_qty[{{$cart['session_id']}}]" class="cart-plus-minus-box cart_quantity" style="border:1px solid #4e555b; width: 50px">
                                                            </td>
                                                            <td style="padding: 10px 20px"  class="product-subtotal">{{number_format($subtotal,0,',','.')}} đ</td>
                                                            <td style="padding: 10px 20px"   class="product-remove">
                                                                <a class="cart_quantity_delete" href="{{\Illuminate\Support\Facades\URL::to('delete-pro-cart/'.$cart['session_id'])}}"><i class="zmdi zmdi-close"></i></a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    ...
                                                    <tr>
                                                        <td colspan="5">
                                                            <input type="submit" value="Cập nhật" name="update_qty" class="btn btn-success btn-sm" style="margin-left: 900px">
                                                        </td>
                                                    </tr>
                                        ...
                                        <div class="row">
                                                <div class="col-md-6">
                                                    <div class="coupon-discount box-shadow p-30 mb-50">
                                                        <form action="{{\Illuminate\Support\Facades\URL::to('check-coupon')}}" method="post">
                                                            @csrf
                                                          <h6 class="widget-title border-left mb-20">mã giảm giá</h6>
                                                          <input type="text" name="coupon" placeholder="Hãy nhập mã giảm giá của bạn.">
                                                            <input type="submit" class="submit-btn-1 black-bg btn-hover-2 check_coupon" name="check_coupon" value="Nhập mã">
                                                        </form>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="payment-details box-shadow p-30 mb-50">
                                                        ...
                                                        @if(Session::get('coupon'))
                                                            @foreach(Session::get('coupon') as $key => $cou)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="order-total-price">{{number_format($total-$total_coupon,0,',','.')}} đ</td>
                                                                </tr>
                                                                @else
                                                                    <tr>
                                                                        <td class="td-title-1">Mã giảm giá</td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="order-total-price">
                                                                            ...
                                                                            @endphp
                                                                            {{number_format($total_coupon,0,',','.')}} đ</td>
                                                                    </tr>
                                                                @endif
                                                    ...
                                                    <a style="margin: 20px 0 0 0;color: white;" class="submit-btn-1 black-bg btn-hover-2 btn btn-default" type="submit" href="{{\Illuminate\Support\Facades\URL::to('unset-coupon')}}">
                                                        Xóa mã khuyến mãi
                                                    </a>
                                                    @endif
                                                    @if(\Illuminate\Support\Facades\Session::get('customer'))
                                                    <a style="margin: 20px 0 0 370px;color: white" class="submit-btn-1 black-bg btn-hover-2 btn btn-default" type="submit" href="{{\Illuminate\Support\Facades\URL::to('checkout')}}">
                                                        Thanh Toán
                                                    </a>
                                                    @else

                                                    <a style="margin: 20px 0 0 370px;color: white" class="submit-btn-1 black-bg btn-hover-2 btn btn-default" type="submit" href="{{\Illuminate\Support\Facades\URL::to('login')}}">
                                                        Thanh Toán
                                                    </a>
                                                    @endif
